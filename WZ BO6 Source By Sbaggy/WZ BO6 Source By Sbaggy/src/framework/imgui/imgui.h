...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsClassic(ImGuiStyle* dst = NULL); // classic imgui style StyleColorsStatic
    IMGUI_API void          StyleColorsStatic(ImGuiStyle* dst = NULL); // vmp imgui style 
    ...
    IMGUI_API ImU32         GetColorU32(const ImVec4& col, float alpha_mul);
    ...
    IMGUI_API bool          CoolCheckbox(const char* label, bool* v);
    IMGUI_API bool          CoolButton(ImVec4 cclr, const char* label, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          CoolIsItemClicked(ImGuiMouseButton mouse_button = 0);
    IMGUI_API void          CoolRenderText(bool pinkte_farbe, float transparency, ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash);
    IMGUI_API bool          EpicButton(ImVec4 cclr, const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          SliderScala1r(float val, const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/imgui/issues/3361
    IMGUI_API bool          SliderFloat(float f, const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);      // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColor1(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0, ImDrawFlags flags = 0);
